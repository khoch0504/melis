...
namespace Pages\Controller\Plugin;
 ...
 * $plugin = $this->PagesPagesPlugin();
 * $pluginView = $plugin->render();
 *
 * How to call this plugin with custom parameters:
 * $plugin = $this->PagesPagesPlugin();
 * $parameters = array(
 *      'template_path' => 'Pages/pages'
 * );
 * $pluginView = $plugin->render($parameters);
 *
 * How to add to your controller's view:
 * $view->addChild($pluginView, 'pages');
 *
 * How to display in your controller's view:
 * echo $this->pages;
 */
class PagesPagesPlugin extends MelisTemplatingPlugin
{
    ...
    public function __construct($updatesPluginConfig = array())
    {
        ...
        $this->pluginXmlDbKey = 'PagesPagesPlugin';
