...
namespace Moduletest\Controller\Plugin;
 ...
 * $plugin = $this->ModuletestPlugintestPlugin();
 * $pluginView = $plugin->render();
 *
 * How to call this plugin with custom parameters:
 * $plugin = $this->ModuletestPlugintestPlugin();
 * $parameters = array(
 *      'template_path' => 'Moduletest/plugintest'
 * );
 * $pluginView = $plugin->render($parameters);
 *
 * How to add to your controller's view:
 * $view->addChild($pluginView, 'plugintest');
 *
 * How to display in your controller's view:
 * echo $this->plugintest;
 */
class ModuletestPlugintestPlugin extends MelisTemplatingPlugin
{
    ...
    public function __construct($updatesPluginConfig = array())
    {
        ...
        $this->pluginXmlDbKey = 'ModuletestPlugintestPlugin';
    ...
    public function loadDbXmlToPluginConfig()
    {
        ...
        if ($xml) {          
			...
			if (!empty($xml->Name))
				$configValues['Name'] = (string)$xml->Name;
			if (!empty($xml->Gender))
				$configValues['Gender'] = (string)$xml->Gender;
			if (!empty($xml->Description))
				$configValues['Description'] = (string)$xml->Description;
    ...
    public function savePluginConfigToXml($parameters)
    {
		...
		if (!empty($parameters['Name']))
			 $xmlValueFormatted .= "\t\t". '<Name><![CDATA[' . $parameters['Name'] . ']]></Name>';
		if (!empty($parameters['Gender']))
			 $xmlValueFormatted .= "\t\t". '<Gender><![CDATA[' . $parameters['Gender'] . ']]></Gender>';
		if (!empty($parameters['Description']))
			 $xmlValueFormatted .= "\t\t". '<Description><![CDATA[' . $parameters['Description'] . ']]></Description>';
